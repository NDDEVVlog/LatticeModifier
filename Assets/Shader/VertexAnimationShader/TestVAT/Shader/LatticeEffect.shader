Shader "Custom/LatticeEffect"
{
    ...
    SubShader
    {
        ...
        void vert(inout appdata_full v)
        {
            ...
            float3 expandDeformation = _AxisInfluence * expandInfluence * _ScaleFactor * _Strength;
            float3 shrinkDeformation = _AxisInfluence * shrinkInfluence * _ScaleFactor * _Strength * -1.0; // Negative for shrinking
            ...
            v.vertex.xyz += v.vertex.xyz * deformation;
        }
